...
impl AiDynamicToolExecutor {
    ...
    pub fn with_state_only_browser() -> Self {
        Self {
            workspace_tools: DynamicToolRegistry::new(),
    ...
    pub fn with_browser_runtime(runtime: BrowserRuntime) -> Self {
        Self {
            workspace_tools: DynamicToolRegistry::new(),
            browser_tools: AiBrowserDynamicToolExecutor {
...
pub enum BrowserToolSafetyMode {
    Enforce,
    AllowSensitiveOnce,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub struct BrowserToolConfirmation {
    pub kind: SensitiveBrowserAction,
    pub summary: String,
}

pub fn execute_browser_dynamic_tool_with_runtime(
...
pub fn execute_browser_dynamic_tool_with_runtime_and_safety(
    runtime: &mut BrowserRuntime,
    params: &DynamicToolCallParams,
    use_backend: bool,
...
pub fn browser_dynamic_tool_confirmation(
    params: &DynamicToolCallParams,
...
pub fn browser_unavailable_response(
    params: &DynamicToolCallParams,
    message: &str,
) -> DynamicToolCallResponse {
...
pub fn browser_confirmation_declined_response(
    params: &DynamicToolCallParams,
) -> DynamicToolCallResponse {
    json_error_response(json!({
